...
@section('title')
    <title>Liste des histories</title>
@endsection
@section('main')
    ...
    <div class="mcontainer">
        <div class="uk-grid-small" uk-grid>
            <div class="container max-w-7xl mx-auto mt-8">
                <div class="mb-4">
                  <h1 class="font-serif text-3xl font-bold underline decoration-gray-400"> Histories</h1>
                  <div class="flex justify-end">
                    ...
                    <a href="{{ route('history.create') }}" class="px-4 py-2 rounded-md bg-sky-500 text-sky-100 hover:bg-sky-600"> Répertorier une history</a>
